...
function IconLocationFood(props) {
    ...
    return (
      ...
      >
        ...
        <path d="M240 304 A24 48 0 0 1 216 352 A24 48 0 0 1 192 304 A24 48 0 0 1 240 304 z" />
        <path d="M320 304 A24 48 0 0 1 296 352 A24 48 0 0 1 272 304 A24 48 0 0 1 320 304 z" />
      </svg>
    );
  }
